...
to círculo
 ...
 clear-all
 create-turtles 1
 ask turtle 0 [pendown set color yellow
...
to tres-círculos
  ...
  crt 1
  ask turtle 0 [
    setxy 3 2 pd set color yellow circulo
    pu setxy 7 -2 set color red pd circulo
    pu setxy -2 -2 set color green pd circulo
    ]
