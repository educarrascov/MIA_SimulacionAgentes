;; velocidades
;; Drones: 8 mt/s = 28.8 Km/h                     rango: 6 a 10
;; Embarcaciones: 4 m/s = 14.4 Km/h = 7.cada 8 nudos   rango: 3 a 5
;; Energía:
;;      Conusmo: 100% es para 800 ticks (13.3 min) -> cada tick (seg) en vuelo consume 1/8 de almacenamiento
...
to main-simulation
  ...
  if (b-actualiza-estadisticas)[
    ...
    ifelse q-drones > 1 [
      ...
      set desviacion-estandar-tiempo-vuelo precision (standard-deviation [tiempo-vuelo] of turtles with [tipo = "drone" and subtipo = "inspector"]) 1
    ]
    [
      set desviacion-estandar 0
      set desviacion-estandar-tiempo-vuelo 0
    ]
  ]
  ;
  ; buscar nuevo objetivo, ajustar rutas y calibrar direcciones
...
to setup_turtles
  ...
  create-turtles q-drones [
    ...
    set tiempo-vuelo 0
    set velocidad random(3) + 6 ; Entre 6 a 8
    set almacenamiento random(51) + 50 ; de 50 a 100
  ...
  create-turtles q-drones [
    ...
    set size q-size-drone
    set shape "store 000"
    set xcor array:item x-initial-position-store (who - q-objetos * 2 - q-drones * 2 - 1)
    set ycor array:item y-initial-position-store (who - q-objetos * 2 - q-drones * 2 - 1)
  ...
  create-turtles q-drones [
    ...
    set size q-size-drone
    set shape "nothing"
    set xcor array:item x-initial-position-label-store (who - q-objetos * 2 - q-drones * 3 - 1)
    set ycor array:item y-initial-position-label-store (who - q-objetos * 2 - q-drones * 3 - 1)
    ifelse administracion-energia [
      show-turtle
    ]
    [
...
to F-asigna-mas-cercano-OBJ
  ...
  ask turtles with [tipo = "object" and estado = "non-inspected" and b-en-perimetro-radar][
    ...
    ask turtles with [tipo = "drone" and subtipo = "inspector" and (estado-energia = "ok" or not administracion-energia)][
...
"" ""
PENS
"drone 1" 1.0 0 -955883 true "" "ask turtle id-primer-drone [plot distancia-recorrida]"
"drone 2" 1.0 0 -1184463 true "" "ask turtle (id-primer-drone + 1) [plot distancia-recorrida]"
"drone 3" 1.0 0 -8630108 true "" "ask turtle (id-primer-drone + 2) [plot distancia-recorrida]"
"drone 4" 1.0 0 -10899396 true "" "ask turtle (id-primer-drone + 3) [plot distancia-recorrida]"
"drone 5" 1.0 0 -13345367 true "" "ask turtle (id-primer-drone + 4) [plot distancia-recorrida]"
...
1484
785
desviacion-estandar-tiempo-vuelo
158.8
1
0
Number
...
"" ""
PENS
"drone 1" 1.0 0 -955883 true "" "ask turtle id-primer-drone [plot tiempo-vuelo]"
"drone 2" 1.0 0 -1184463 true "" "ask turtle (id-primer-drone + 1) [plot tiempo-vuelo]"
"drone 3" 1.0 0 -8630108 true "" "ask turtle (id-primer-drone + 2) [plot tiempo-vuelo]"
"drone 4" 1.0 0 -10899396 true "" "ask turtle (id-primer-drone + 3) [plot tiempo-vuelo]"
"drone 5" 1.0 0 -13345367 true "" "ask turtle (id-primer-drone + 4) [plot tiempo-vuelo]"
